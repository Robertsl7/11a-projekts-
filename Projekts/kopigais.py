...
class klienta_informacija(): #glabā klienta datus
    ...
    def izvade(self): #izvada ievadītos datus uz ekrāna
    ...
    def abonesana(self): #paņem šī brīža laiku un aprēķina abonamenta beigšanās datumu
        ...
        while True: #pēc izvēles aprēķina abonamenta beigu datumu
    ...
    def failu_izveide(self): #izveido failu ar klienta vārdu un ieraksta tajā visu klienta informāciju
...
def izveleties_abonamentu(): #izvada visas abonamenta opcijas
    print("\nIzvēlaties abonamenta veidu: \n1- dienas abonaments \n2- nedēļas abonaments \n3- mēneša abonaments \n4- gada abonaments")



def atcelt_abonamentu(): #izdžēš klienta profilu
...
def galvena(): #izsauc funkcijas un ļauj ievadīt datus
    while True:
